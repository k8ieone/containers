...
docker buildx build . --platform=linux/$1 -t k8ieone/arch-builder:blender-$1 --load
docker run --cidfile $CIDFILE k8ieone/aur-builder:blender-$1 /usr/bin/file /home/builder/blender-cmake/blender.zip
